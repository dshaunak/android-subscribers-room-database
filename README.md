1. This is a simple project to implement concepts such as Kotlin Room Database, Kotlin Coroutines, RecyclerView, Repositories in MVVM, ViewModel Factory, EventWrappers, Kotlin higher order functions.
